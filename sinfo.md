...
* **Only one** fuel duct **leading out** of a _fuel zone_ (group of tanks and engines) into another target group is supported. No such limit is imposed on **incoming** fuel ducts into a _fuel zone_. This is a limitation of the underlying framework. 
